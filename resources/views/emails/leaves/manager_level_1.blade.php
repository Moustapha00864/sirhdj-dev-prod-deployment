...
<head>
    <meta charset="UTF-8">
    <title>Demande de congé – Approbation requise (Niveau 1)</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="header">
        <h3>Alerte – Demande de congé en attente d’approbation (Niveau 1)</h3>
    </div>
    ...
    <p>
        Merci de bien vouloir examiner la demande et confirmer votre décision :
    </p>
    ...
    <ul>
        ...
        <li><strong>Période demandée :</strong>
