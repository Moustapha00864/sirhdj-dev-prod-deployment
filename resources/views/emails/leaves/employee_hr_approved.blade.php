...
<head>
    <meta charset="UTF-8">
    <title>Demande de congé validée par les RH</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="header">
        <h3>Notification – Demande de congé validée par les RH</h3>
    </div>
    ...
    <p>
        ...
        <strong>validée par le service RH</strong>.
    </p>

    <p>
        La demande est désormais transmise à la
        <strong>Direction</strong> pour approbation finale.
    </p>
