...
export default function EmployeeEdit() {
  ...
  const [formData, setFormData] = useState<Record<string, any>>({
    ...
    birth_place: employee.employee?.birth_place || '',
    personnel_category: employee.employee?.personnel_category || '',
    documents: []
  });
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="birth_place">{t('Lieu de naissance')}</Label>
                <Input
                  id="birth_place"
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="personnel_category">{t('PERSONNEL')}</Label>
                <Select
                  value={formData.personnel_category}
                  onValueChange={(value) => handleChange('personnel_category', value)}
                >
                  <SelectTrigger className={errors.personnel_category ? 'border-red-500' : ''}>
                    <SelectValue placeholder={t('Select Personnel Category')} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Administration">{t('Administration')}</SelectItem>
                    <SelectItem value="Paramédical">{t('Paramédical')}</SelectItem>
                    <SelectItem value="Médical">{t('Médical')}</SelectItem>
                    <SelectItem value="Technique et Soutien">{t('Technique et Soutien')}</SelectItem>
                  </SelectContent>
                </Select>
                {errors.personnel_category && <p className="text-red-500 text-xs">{errors.personnel_category}</p>}
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="employment_type">{t('STATUT')}</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="Universitaire">{t('Universitaire')}</SelectItem>
                    <SelectItem value="Collectivité Locale">{t('Collectivité Locale')}</SelectItem>
                    <SelectItem value="CDD du MSHP">{t('CDD du MSHP')}</SelectItem>
                  </SelectContent>
                </Select>
